...
router.post('/garments', requireAdmin, (req, res) => {
  const b = req.body;
...
router.put('/garments/:id', requireAdmin, (req, res) => {
  const b = req.body;
...
router.post('/garments/:id/image', requireAdmin, imageUpload.single('image'), (req, res) => {
...
router.post('/garments/:id/colors', requireAdmin, (req, res) => {
  const b = req.body;
...
router.put('/colors/:id', requireAdmin, (req, res) => {
  const b = req.body;
...
router.delete('/colors/:id', requireAdmin, (req, res) => {
  db.prepare('DELETE FROM garment_colors WHERE id=?').run(req.params.id);
  res.json({ ok: true });
});

router.post('/garments/:id/sizes', requireAdmin, (req, res) => {
  const b = req.body;
...
router.put('/sizes/:id', requireAdmin, (req, res) => {
  const b = req.body;
...
router.delete('/sizes/:id', requireAdmin, (req, res) => {
